...
{
    public class UpgradeLineEdit : TextBox, Moving_Resizing  //Определяем класс улучшенного поля для ввода. Наследуемся от
        //стандартного поля для ввода и придерживаемся интерфейсу перемещения и изменения размеров
    {

        public UpgradeLineEdit() : base() //Конструктор -дубируем конструктор класса родителя
        {
